package com.style.datasource.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.pool.xa.DruidXADataSource;
import com.atomikos.jdbc.AtomikosSQLException;
import com.style.datasource.DatasourceException;
import com.style.datasource.plugin.Pool;
...
public class DataSourceAutoConfiguration {
    ...
    public static DataSource initDataSource(String dataSourceName, DataSource dataSource) throws SQLException {
        Pool entity = getDataSourceConfig(dataSourceName);
     ...
     */
    public static Pool getDataSourceConfig(String dataSourceName) {
        String dataSourceKey = DATA_SOURCE_KEY_PREFIX;
        return new Pool(dataSourceName,
