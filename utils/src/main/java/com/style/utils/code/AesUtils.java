...
public class AesUtils {
    ...
    public static String encode(String input) {
        try {
            return CodeUtils.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), DEFAULT_KEY));
    ...
    public static String decode(String input) {
        try {
            return new String(decode(CodeUtils.decodeHex(input), DEFAULT_KEY), DEFAULT_URL_ENCODING);
        } catch (UnsupportedEncodingException e) {
            return StringUtils.EMPTY;
        }
    }
    ...
    public static String encode(String input, String key) {
        try {
            return CodeUtils.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), CodeUtils.decodeHex(key)));
        } catch (UnsupportedEncodingException e) {
            return StringUtils.EMPTY;
        }
    }
    ...
    public static String decode(String input, String key) {
        try {
            return new String(decode(CodeUtils.decodeHex(input), CodeUtils.decodeHex(key)), DEFAULT_URL_ENCODING);
        } catch (UnsupportedEncodingException e) {
            return StringUtils.EMPTY;
        }
    }
    ...
    public static String genKeyString() {
        return CodeUtils.encodeHex(genKey(DEFAULT_AES_KEY_SIZE));
    }
