...
@Service
public class SysMailLogServiceImpl extends CrudServiceImpl<SysMailLogDao, SysMailLogEntity> implements SysMailLogService {

    protected QueryWrapper<SysMailLogEntity> getWrapper(Map<String, Object> params) {
