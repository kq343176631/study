package com.style.admin.modules.security.oauth2;

import com.style.admin.modules.security.entity.SysUserTokenEntity;
import com.style.admin.modules.security.service.ShiroService;
import com.style.admin.modules.security.user.UserDetail;
...
public class Oauth2Realm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        if(tokenEntity == null || tokenEntity.getExpireDate().getTime() < System.currentTimeMillis()){
            throw new IncorrectCredentialsException(MsgUtils.getMessage(ErrorCode.TOKEN_INVALID));
        }
        ...
        if(userDetail.getStatus() == 0){
            throw new LockedAccountException(MsgUtils.getMessage(ErrorCode.ACCOUNT_LOCK));
        }
