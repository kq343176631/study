...
import com.style.common.mybatis.CommonFieldHandler;
import com.style.utils.lang.ListUtils;
import com.style.utils.lang.ObjectUtils;
import com.style.utils.lang.StringUtils;
import com.style.utils.ResourceUtils;
import com.style.datasource.MybatisTransactionFactory;
import com.style.common.mybatis.annotation.MyBatis;
import com.style.common.mybatis.injector.CrudSqlInjector;
import com.style.datasource.plugin.DataSourceInterceptor;
...
public class MyBatisAutoConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(DataSource dataSource) throws Exception {
        ...
        // 设置事务工厂
        factory.setTransactionFactory(new MybatisTransactionFactory());
    ...
    public static MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        // 设置DAO注解
        scanner.setAnnotationClass(MyBatis.class);
        // 设置包扫描路径
